...
public class Manifestation  implements java.io.Serializable {
    ...
    public Manifestation(int manifestationId, Integer fkLocalisationId, String fkIdType, Integer nbPlace, String nomManifestation, Date date, String adresse, String description, Double prix) {
       this.manifestationId = manifestationId;
    ...
    public void setType(String fkIdType) {
        this.type = fkIdType;
    }
