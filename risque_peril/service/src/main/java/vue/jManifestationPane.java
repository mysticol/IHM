...
public class jManifestationPane extends javax.swing.JPanel implements EntityPane<Manifestation>{
    ...
    private void initComponents() {
        ...
        buttonFwIDLocalisation.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonFwIDLocalisationActionPerformed(evt);
            }
        });
    ...
    private void buttonFwIDLocalisationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFwIDLocalisationActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_buttonFwIDLocalisationActionPerformed
    ...
    public Manifestation getEntity() {
        ...
        if (fieldFkLocalisation.getText() == "" ) {
            ...
            result.setType((fieldId1.getText()));
    ...
    public void loadEntity(Manifestation entity) {
        ...
        this.fieldFkType.setText(String.valueOf(entity.getType()));
