...
INSERT INTO HOTEL(FK_LOCALISATION_ID,NOM_HOTEL,ADRESSE,NB_CHAMBRE,RANK_HOTEL,PRIX_MOYEN,PRIX) VALUES(1,'le duchesse anne','4 Place Marc Elder',50,3,100,100);	/* id : 1 */
...
INSERT INTO RESTAURANT(FK_LOCALISATION_ID,ADRESSE,NOM_RESTAURANT,NB_COUVERTS,RATE_RESTAURANT,PRIX_MOYEN,PRIX) VALUES(1,'2 Rue Armand Brossard','creperie bleu',50,2,10,10);		/* id : 1 */
...
INSERT INTO MANIFESTATION(FK_LOCALISATION_ID,FK_ID_TYPE,NB_PLACE,NOM_MANIFESTATION,DATE,ADRESSE,DESCRIPTION,PRIX) VALUES(1,1,2000,'johnny','2010-12-12','Avenue Carnot','description',1000);		/* id : 1 */
