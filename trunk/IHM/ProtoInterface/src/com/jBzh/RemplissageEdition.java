...
import com.jBzh.EditionNumericAdapter.EditionNumericAdapterListener;
import com.jBzh.EditionNumericTextAdapter.EditionNumericTextAdapterListener;
import com.jBzh.EditionNumericTextAdapter2.EditionNumericTextAdapterListener2;
...
public class RemplissageEdition extends Activity implements EditionNumericAdapterListener,EditionNumericTextAdapterListener, EditionNumericTextAdapterListener2 {
	...
	private EditionNumericAdapter adapter;
	private EditionNumericTextAdapter adapterText;
	private EditionNumericTextAdapter2 adapterText2;
	private RemplissageEdition instance;
	...
	public void onCreate(Bundle savedInstanceState) {
	  ...
	  setContentView(R.layout.remplissageedition);
	  ...
	  if(categorie.equalsIgnoreCase("Personnage")){
		  ...
		  EditionNumericTextAdapter adapter = new EditionNumericTextAdapter(this, listNText);
		 ...
		 final EditionNumericTextAdapter2 adapter = new EditionNumericTextAdapter2(this, listNText);
		  ...
		  boutonMoins.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(listNText.size()!=0){
					...
					EditionNumericTextAdapter2 adapterMoins = new EditionNumericTextAdapter2(instance, listNText);
		  ...
		  boutonPLus.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TODO on ajoute une ligne
					...
					EditionNumericTextAdapter2 adapterPlus = new EditionNumericTextAdapter2(instance, listNText);
      ...
      buttonRetour.setOnClickListener(new View.OnClickListener() {
          public void onClick(View v) {
  			...
  			Intent intent = new Intent(RemplissageEdition.this, ListEditionNumeric.class);
