...
public class EditionNumericAdapter extends BaseAdapter {
	...
	// Constructeur
	public  EditionNumericAdapter(Context context, List<Numeric> listNum) {
		listNumeric = listNum;
		mContext = context;
    ...
    private ArrayList< EditionNumericAdapterListener> mListListener = new ArrayList< EditionNumericAdapterListener>();
    public void addListener( EditionNumericAdapterListener aListener) {
    	mListListener.add(aListener);
    }
	
    public interface  EditionNumericAdapterListener {
