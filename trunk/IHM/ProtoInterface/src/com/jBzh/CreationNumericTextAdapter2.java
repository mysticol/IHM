...
public class CreationNumericTextAdapter2 extends BaseAdapter{
...
private Integer firstTime;
	...
	// Constructeur
	public CreationNumericTextAdapter2(Context context, List<NumericText> listNum) {
		listNumeric = listNum;
		mContext = context;
    ...
    private ArrayList<CreationNumericTextAdapterListener2> mListListener = new ArrayList<CreationNumericTextAdapterListener2>();
    public void addListener(CreationNumericTextAdapterListener2 aListener) {
    	mListListener.add(aListener);
    }
	
    public interface CreationNumericTextAdapterListener2 {
