...
\usepackage {multicol}
% Pour cr̩̩er un index
\usepackage{makeidx}
\makeindex

% Pour g̩rer les liens interractifs et les signets Acrobat
\usepackage{hyperref}
\hypersetup{
pdftitle={TP 5 : JMS},
pdfauthor={Fortun, Caillaud, Dejean, Pottier},
pdfsubject={TP 5 : JMS},
bookmarks, % Cr̩ation du signet
pdfstartview=FitH, % Page de la largeur de la fen̻tre
...
urlcolor=black, 	
frenchlinks=black,
bookmarksnumbered=true, % Signet num̩rot̩
...
%----------------------------------------
% Citer tous les ouvrages/r̩f̩rences
% \nocite{*}
