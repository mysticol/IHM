...
public class JaugeMJ extends Activity implements CreationJaugeAdapterListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    buttonJaugeToRoll.setOnClickListener(new View.OnClickListener() {
	          public void onClick(View v) {
	  			...
	  			Intent intent = new Intent(JaugeMJ.this, ChoixJetMJ.class);
	    ...
	    buttonJaugeToFiche.setOnClickListener(new View.OnClickListener() {
	          public void onClick(View v) {
	  			...
	  			//On créé l'Intent qui va nous permettre d'afficher l'autre Activity
	  			Intent intent = new Intent(JaugeMJ.this, FicheViewerMJ.class);
