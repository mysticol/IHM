...
public class ChoixJetMJ extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
      ...
      buttonRollToJauge.setOnClickListener(new View.OnClickListener() {
          public void onClick(View v) {
  			...
  			Intent intent = new Intent(ChoixJetMJ.this, /*getParent().getClass()*/ JaugeMJ.class);
      ...
      buttonRollToFiche.setOnClickListener(new View.OnClickListener() {
          public void onClick(View v) {
  			...
  			//On créé l'Intent qui va nous permettre d'afficher l'autre Activity
  			Intent intent = new Intent(ChoixJetMJ.this, FicheViewerMJ.class);
      ...
      buttonLibre.setOnClickListener(new View.OnClickListener() {
          public void onClick(View v) {
        	  ...
        	  //On créé l'Intent qui va nous permettre d'afficher l'autre Activity
        	  Intent intent = new Intent(ChoixJetMJ.this, DiceLauncherMJ.class);
